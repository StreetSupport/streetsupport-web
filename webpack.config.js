...
module.exports = {
  entry: {
    ...
    'by-client-group-map': path.join(__dirname, '/src/js/pages/find-help/by-client-group/map/app'),
    'by-client-group-timetable': path.join(__dirname, '/src/js/pages/find-help/by-client-group/timetable/app'),
